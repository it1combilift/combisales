 ...
 * Get a specific Zoho CRM project by ID
 * - ADMIN users: Can see any project
 * - SELLER users: Can only see their own projects (Owner email must match)
 */
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      {
        error: "Error al obtener proyecto de Zoho CRM",
