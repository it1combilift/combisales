      ...
      >
        <Tabs defaultValue="personal" className="flex flex-col flex-1 min-h-0">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto">
            ...
            {/* ── Security ── */}
            <TabsContent value="security" className="space-y-4 mt-0 pb-1">
              <FormField
                control={form.control}
                name="password"
                render={({ field }) => (
        ...
        {/* ── Action buttons — always pinned, never scroll away ── */}
        <div className="grid grid-cols-2 gap-3 pt-4 mt-2 border-t border-border/60 shrink-0">
          <Button
            type="button"
            variant="outline"
            onClick={() => form.reset()}
