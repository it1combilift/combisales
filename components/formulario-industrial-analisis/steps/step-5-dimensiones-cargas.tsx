    ...
    <div className="border rounded-lg p-3 bg-card hover:bg-muted/20 transition-colors">
      <div className="flex items-center gap-2 mb-3">
        ...
        <Input
          ...
          className="h-9 text-sm flex-1 text-balance"
        />
          ...
          <div key={key} className="space-y-1">
            ...
            <div className="relative">
              <Input
                ...
                className="h-9 text-sm pr-8 font-mono text-balance"
              />
          ...
          <div className="space-y-2 pt-2 border-t">
            ...
            {!isValid && dimensionesCargas.length > 0 && (
              <p className="text-sm text-destructive flex items-center gap-1">
                <span className="size-1 rounded-full bg-destructive inline-block text-sm" />
