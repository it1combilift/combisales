  ...
  'inline-flex items-center justify-center rounded-md border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-transparent bg-destructive text-white shadow-sm shadow-destructive/20 [a&]:hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/80 dark:shadow-destructive/30',
        ...
        success:
          'border-green-200 bg-green-50 text-green-700 shadow-sm [a&]:hover:bg-green-100 [a&]:hover:border-green-300 dark:border-green-800/50 dark:bg-green-950/50 dark:text-green-400 dark:[a&]:hover:bg-green-950/70',

        warning:
          'border-amber-200 bg-amber-50 text-amber-700 shadow-sm [a&]:hover:bg-amber-100 [a&]:hover:border-amber-300 dark:border-amber-800/50 dark:bg-amber-950/50 dark:text-amber-400 dark:[a&]:hover:bg-amber-950/70',

        info:
          'border-blue-200 bg-blue-50 text-blue-700 shadow-sm [a&]:hover:bg-blue-100 [a&]:hover:border-blue-300 dark:border-blue-800/50 dark:bg-blue-950/50 dark:text-blue-400 dark:[a&]:hover:bg-blue-950/70',
        ...
        pink:
          'border-pink-200 bg-pink-50 text-pink-700 shadow-sm [a&]:hover:bg-pink-100 [a&]:hover:border-pink-300 dark:border-pink-800/50 dark:bg-pink-950/50 dark:text-pink-400 dark:[a&]:hover:bg-pink-950/70',

        teal:
          'border-teal-200 bg-teal-50 text-teal-700 shadow-sm [a&]:hover:bg-teal-100 [a&]:hover:border-teal-300 dark:border-teal-800/50 dark:bg-teal-950/50 dark:text-teal-400 dark:[a&]:hover:bg-teal-950/70',
        ...
        dot:
          'border-border bg-background text-foreground shadow-sm pl-1.5 before:content-[""] before:size-1.5 before:rounded-full before:bg-current before:inline-block before:mr-1 [a&]:hover:bg-accent dark:border-border/70 dark:bg-background/50',
      },
