...
const PDF_LABELS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    photoFront: "Front",
    photoRear: "Rear",
    photoLeftSide: "Left Side",
    photoRightSide: "Right Side",
    photoInterior: "Interior",
    photoEngineDashboard: "Dashboard with Engine On",
    photoWheelFrontLeft: "Front Left Wheel",
    photoWheelFrontRight: "Front Right Wheel",
    photoWheelRearLeft: "Rear Left Wheel",
    photoWheelRearRight: "Rear Right Wheel",
  ...
  es: {
    ...
    photoFront: "Frontal",
    photoRear: "Trasera",
    photoLeftSide: "Lateral Izquierdo",
    photoRightSide: "Lateral Derecho",
    photoInterior: "Interior",
    photoEngineDashboard: "Cuadro con Motor Encendido",
    photoWheelFrontLeft: "Rueda D/I",
    photoWheelFrontRight: "Rueda D/D",
    photoWheelRearLeft: "Rueda T/I",
    photoWheelRearRight: "Rueda T/D",
...
function InspectionPdfDocument({
  ...
  const PHOTO_LABELS: Record<string, string> = {
    FRONT: t.photoFront,
    REAR: t.photoRear,
    DRIVER_SIDE: t.photoLeftSide,
    PASSENGER_SIDE: t.photoRightSide,
    INTERIOR: t.photoInterior,
    SAFETY_DEVICES: t.photoEngineDashboard,
    WHEEL_FRONT_LEFT: t.photoWheelFrontLeft,
    WHEEL_FRONT_RIGHT: t.photoWheelFrontRight,
    WHEEL_REAR_LEFT: t.photoWheelRearLeft,
    WHEEL_REAR_RIGHT: t.photoWheelRearRight,
  };
